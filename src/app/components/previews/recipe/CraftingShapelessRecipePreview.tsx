...
import { generateItemsForShapelessRecipe } from './CraftingShapelessRecipe.js'

export default function CraftingShapelessRecipePreview({ data }: { data: any }) {
	...
	useEffect(() => {
		...
		generateItemsForShapelessRecipe(data, version).then(newItems => {
			setItems(newItems)
		})
	...
	return <>
		<div class='preview-overlay'>
			...
			<img src='/images/crafting_shapeless.png' class='pixelated' draggable={false} />
